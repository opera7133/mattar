...
import { BsSearch, BsThreeDots, BsStar, BsReply } from 'react-icons/bs'
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-400">
                          ...
                          <span className="ml-3 duration-200 opacity-0 group-hover:opacity-100">
                            <button className="duration-200 hover:text-orange-400">
                              <BsStar className="inline-block mb-1" />
                              お気に入り
                            </button>
                          </span>
                          <span className="ml-2 duration-200 opacity-0 group-hover:opacity-100">
          ...
          <div className="col-span-1 py-4">
            <div className="px-3 flex gap-3 items-center">
              ...
              <div>
                ...
                <p>
                  {
                    props.mattars.filter((n) => n.userId === props.user.id)
                      .length
                  }
                  のつぶやき
                </p>
            ...
            <div className="flex flex-col">
              <Link href="/">
                <a className="px-3 py-1 bg-primary text-white">ホーム</a>
              </Link>
              <Link href="/at">
        ...
        <div className="col-span-2 py-4">
          ...
          <div className="my-6">
            ...
            <div className="flex flex-col gap-1">
              {props.mattars.map((item) => {
                return (
                  <article className="relative flex gap-3 group" key={item.id}>
                    <img
                      src={
                        item.user.profile_picture
                          ? item.user.profile_picture
