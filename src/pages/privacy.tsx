    ...
    <div className="">
      ...
      <article className="pt-10 mb-10 min-h-[60vh] container mx-auto px-5 max-w-6xl">
        ...
        <details className="my-3 prose lg:prose-md dark:prose-invert">
          ...
          <h2>第2条（個人情報の収集方法）</h2>
          <p>
            当団体は、ユーザーが利用登録をする際に生年月日、電話番号、メールアドレスなどの個人情報をお尋ねすることがあります。また、ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録に関する情報を、当団体の提携先（情報提供元、広告主、広告配信先などを含みます。以下、｢提携先｣といいます。）などから収集することがあります。
          </p>
          ...
          <ol>
            <li>
              当団体は、本人から個人情報の開示を求められたときは、本人に対し、遅滞なくこれを開示します。ただし、開示することにより次のいずれかに該当する場合は、その全部または一部を開示しないこともあり、開示しない決定をした場合には、その旨を遅滞なく通知します。なお、個人情報の開示に際しては、1件あたり1000円の手数料を申し受けます。
              <ol>
                <li>
        ...
        <h2 className="text-2xl font-bold mb-3">プライバシーポリシーの要約</h2>
        <h3 className="text-xl font-bold my-3">
          ℹ️収集する又は今後収集する可能性のある情報
        </h3>
        ...
        <ul className="list-disc ml-10">
          <li>行政から要求があった場合登録情報を提供します</li>
          <li>
            登録されたメールアドレスはmattar.liの新機能のお知らせなどに使用されます
          </li>
          <li>
            個人情報が不正である場合にアカウントを凍結または削除する可能性があります
          </li>
        </ul>
      </article>
      <Footer />
